import { X, Play, Plus, Check, Heart, Star, Clock, Calendar } from "lucide-react";
          ...
          <div className="relative">
            <div className="relative h-[40vh] w-full">
              ...
              <Button
                variant="ghost"
                size="icon"
                className="absolute top-4 right-4 rounded-full bg-black/50 backdrop-blur-sm hover:bg-black/70"
              ...
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-3 mb-6">
                    ...
                    >
                      <Heart className={`mr-2 h-5 w-5 ${isInFavorites ? "fill-accent text-accent" : ""}`} />
